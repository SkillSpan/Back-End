                ...
                <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius: 8px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 8px 32px 32px 32px; color:#222222; line-height:1.6;">
                            <h2 style="margin: 0 0 16px 0; color:#14213d;">Welcome, {{ $name }}!</h2>
                            <p style="margin: 0 0 16px 0;">Thank you for signing up for SkillSpan.</p>
                            <p style="margin: 0 0 16px 0;">Please use the following code to verify your account:</p>
                            ...
                            <p style="margin: 0 0 24px 0;">If you did not create this account, you can safely ignore this email.</p>
