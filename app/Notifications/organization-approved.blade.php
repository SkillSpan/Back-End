                ...
                <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius: 8px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 8px 32px 32px 32px; color:#222222; line-height:1.6;">
                            ...
                            <p style="margin: 0 0 16px 0;">Great news! Your organization, "<strong>{{ $organizationName }}</strong>", has been reviewed and approved by the SkillSpan team.</p>
                            <p style="margin: 0 0 24px 0;">Your organization account is now fully verified and you have complete access to the platform.</p>
